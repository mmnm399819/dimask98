...
<style>
.amirdonity {
position: absolute;transform:matrix(1, 0, 0, 1, 86, 0);
margin-top: 2px;
width: 300px;
height: 60px;
float: left;
...
margin-bottom: 2px;text-align: right!important;}

label.fl.label.loginstat {
background-color: transparent!important;
position: absolute;
top: 0;
margin-top: 4px;left: 0;}
...
a.btn.minix.fa.fa-comment.fr {background-color: #2b3e52!important;float: left;padding: 0px 4px 4px;color: #ffffff!important;}a.btn.minix.fa.fa-thumbs-up.fr {background-color: #2b3e52!important;margin-right: 50px;padding: 0px 4px 4px;color: #ffffff!important;}a.btn.minix.fa.fa-times.fr{background-color: #2b3e52!important;padding: 0px 4px 4px;color: #ffffff!important;}
textarea.form-control.borderg.primaryborder.corner.fr.u-topic {
    font-size: 16px!important;
}
textarea.form-control.borderg.primaryborder.corner.fr.ulikeins {
    font-size: 16px!important;
}
</style>`).insertBefore('body');
$(".u-pic").css("border-radius","24px");
...
$(`<!--<a class="fl fa fa-image btn ui-corner-all ui-shadow ui-btn ui-btn-inline borderg" style="color:purple;margin:2px;width: 106px;text-align: center;font-size:15px!important;"><span dir="rtl"> (0) </span><span style="font-size: 15px!important;">Ø§Ù…ÙŠØ± Ø¯ÙˆÙ†ÙŠØªÙŠ</span></a>-->
<a href="amir donity" target="_blank" style="width:107px; margin-right: 5px;
margin-left: 2px;text-align: center;float: right;border-radius: 5px;
border-color: #990033;
padding: 3px;font-family: 'Cairo', sans-serif, Fontawesome;font-size: 13px!important;" class="SLPBeats fab fa-angellist" >Style By:amir donity</a>`).insertBefore('a.fl.fa.fa-ban.btn.ui-corner-all.ui-shadow.ui-btn.ui-btn-inline.umute.borderg');
