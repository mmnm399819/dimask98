<html lang="ar" hreflang="ar-sa" style="height: 634px;"><head>
  <meta content="text/html; charset=utf-8" http-equiv="Content-Type">
  <meta charset="UTF-8">
  <meta http-equiv="X-UA-Compatible" content="IE=Edge">
  <meta property="og:title" content="شات سوريا للجوال _شات كرم للجوال_شات سوريا للجوال _شات فله_شات الحب_شات للجوال_شات بدون تسجيل _شات كتابي_شات العرب">
  <meta property="og:description" content="شات الشام للجوال _شات كرم للجوال_شات سوريا للجوال _شات فله_شات الحب_شات للجوال_شات بدون تسجيل _شات كتابي_شات العرب">
  ...
  <title>شات سوريا للجوال _شات كرم للجوال_شات سوريا للجوال _شات فله_شات الحب_شات للجوال_شات بدون تسجيل _شات كتابي_شات العرب</title>
  <meta name="description" content="شات الشام للجوال _شات كرم للجوال_شات سوريا للجوال _شات فله_شات الحب_شات للجوال_شات بدون تسجيل _شات كتابي_شات العرب">
  <meta content="شات الشام للجوال _شات كرم للجوال_شات سوريا للجوال _شات فله_شات الحب_شات للجوال_شات بدون تسجيل _شات كتابي_شات العرب" name="keywords">
  <script> 
    window.port=2083
    window.scrollTo(0,1);
  </script>
  ...
  <style>
    * {
    ...
    .label-primary,.btn-primary{  
      background-color: #023044!important;
    }
    .hid {
      display: none;
    }
...
<body class="bg" onload="if (typeof load == 'undefined'){setTimeout('location.reload();',6000);return;};load();" style="background-color: rgb(64, 64, 79); height: 100%; max-height: 100%; margin: 0px; padding: 0px; overflow: hidden; zoom: 1;">
  <div style="width:100%; height:100%;max-height:100%;max-width:380px;padding:0px;" class="center-block bg dad">
    ...
    <div class="hid">
      ...
      <a onclick="location.href='/';" class="label label-primary   fl" style="width:100%;padding:6px;border-radius:0px;text-align: left;"><img src="prv1.png?2" class="fl" style="margin-right: 2px; width:28px;">شــات الشام للجوال_شات كــرم الشام <button class="btn fr btn-success fa fa-refresh" style="margin:0px;margin-top:-2px;" disabled="disabled"></button></a>
      ...
      <div id="l1" style="padding:8px;width:100%;" class="grow break tab-pane fade in active">
        ...
        <button onclick="login(1);" class="btn btn-primary" disabled="disabled">دخول</button><br>&nbsp;
      </div>
      <div id="l2" style="padding:8px;width:100%;" class="grow break tab-pane fade hid">
        ...
        <button onclick="login(2);" class="btn btn-primary" disabled="disabled">دخول</button>
      ...
      <div id="l3" style="padding:8px;width:100%;" class="grow break tab-pane fade hid">
        ...
        <button onclick="login(3);" class="btn btn-primary" disabled="disabled">دخول</button>
      </div>
         <h6 class="hid">
      شــات الشام للجوال_شات كــرم الشام 
    </h6> 
      ...
      <div class="lonline light break" style="width: 100%; outline: lightgray solid 1px; height: 417.065px;">
      </div>
    </div> 
    <div id="room" style="height: 100%; width:100%; " class="break  fr  ">

      <div id="d2" onclick="$('.dpnl').hide();" class="d2   light filh  break" style="height: 566px;">
      </div>
      <div onclick="$('.dpnl').hide();" class="tablebox footer fl light" style="border-bottom-right-radius: 1em;width:100%; padding: 1px;">
        ...
        <textarea id="tbox" onclick="$('.pop').pop('hide');setTimeout(function(){$('#d2').scrollTop($('#d2')[0].scrollHeight);},600);" placeholder="اكتب رسالتك هنا" class="fl corner tbox filw" style="background-color: rgb(170, 170, 175); width: 238px;"></textarea>
    ...
    <div id="d0" onclick=" " class="nosel fl  bg" style="padding-left: 1px; margin-top: 1px; width: 100%;  ">
      <label title="المتواجدين" href="#" onclick="$('.pnhead').text($(this).attr('title'));setTimeout(function(){$('#users').scrollTop(0);},100);$('.dpnl').show();$('#usearch').val('');" data-toggle="tab" data-target="#users" class="ae fa label label-primary fa-user"><span class="busers minix  badge border" style="margin-top:-8px;padding:1px 4px;">0</span></label>
          <label title="المحادثات الخاصه" href="#" onclick="$('.pnhead').text($(this).attr('title'));hl($(this),'primary');setTimeout(function(){$('#users').scrollTop(0);},100);$('.dpnl').show();" data-toggle="tab" data-target="#chats" class="ae fa chats label label-primary fa-comment"><span class=" minix  badge border" style="margin-top:-8px;padding:1px 4px;">0</span></label>
      <label title="غرف الدردشه" href="#" onclick="$('.pnhead').text($(this).attr('title'));$('.dpnl').show();" data-toggle="tab" data-target="#rooms" class="ae fa label label-primary fa-users"><span class="brooms minix  badge border" style="margin-top:-8px;padding:1px 4px;">0</span>الغرف</label>
      <label title="الحائط" href="#" onclick="$('.pnhead').text($(this).attr('title'));$('.dpnl').show();setTimeout(function(){$('#d2bc').scrollTop(0);},100);hl($(this),'primary');$(this).find('.bwall').text('0');bcc=0;" data-toggle="tab" data-target="#wall" class="ae fa label label-primary fa-commenting-o"><span class="bwall  minix badge border" style="margin-top:-8px;padding:1px 4px;">0</span>الحائط</label>
...
<div class="dpnl bg   tab-content" style="display: none; border: 1px solid; border-top-left-radius: 0.5em; width: 290px; padding-top: 20px; padding-bottom: 8px; height: 601px; position: absolute; top: 0px; left: 90px;">
      ...
      <div id="users" style="height: 100%;width:100%;" class="light break tab-pane active">
        <textarea type="search" id="usearch" placeholder=".. البحث" class="tbox bg border" style="width:100%;padding-left:5px;display:block;"></textarea>
      ...
      <div id="wall" style="height: 100%; width: 100%;" class="break tab-pane border hid">  
        <div id="d2bc" class="d2 light fl  d2bc filh    break  " style="width: 100%; height: 99px;">
        </div>
          ...
          <textarea placeholder="اكتب رسالتك هنا" class="fl tbox corner tboxbc filw" style="width: 47px;"></textarea>
          <button onclick="sendbc();" style=" margin-top:2px;margin-left:2px;" class="fa fa-send sndbc fl btn btn-primary">إرسال</button>
        </div>
      </div>
      <div id="rooms" style="height: 100%;width:100%;" class="light border break tab-pane hid">
      ...
      <div id="chats" style="height: 100%;width:100%;" class="light break border tab-pane  hid">
      </div>
      <div id="settings" style="height: 100%;width:100%;padding:0px 5px;" class="break border light tab-pane  hid">
...
<br>
      <label onclick="pmsg();" style="background-color: ghostwhite;color: black;margin:4px; padding:8px;width:98%;" class="label tc border pmsg  btn  label-info fl"><div style=" color:red;text-align: center;margin-bottom: 10px; font-family:'jazeera-light', Fontawesome"> دمشقي / الاعلانات للضرورة فقط</div><span class="fl fa fa-send"></span>إرسال إعلان</label>
     <br>
     <label onclick="if(myroom!=null){redit(myroom);}" style="background-color: ghostwhite; color: black; margin: 4px; padding: 8px; width: 98%; display: none;" class="label tc border redit  btn  label-info fl"><span class="fl fa fa-home"></span>إداره الغرفه</label>
     <br>
      ...
      <div class="modal-content" style="width:340px;margin:-1px;">
        ...
        <div class="modal-body" style="padding:1px;">
          <div class="light fl pro center break" style="width:100%;border:1px solid lightgrey; padding:0px;margin:0px;">
            ...
            <a data-trigger="focus" tabindex="0" data-toggle="popover" class="fl fa fa-diamond btn ui-corner-all ui-shadow ui-btn ui-btn-inline ugift borderg" style="color:blue;margin:2px;width: 106px;text-align: center;">ارسل هديه</a>
...
<label class="btn btn-primary u-nickc fr fa fa-save">تغير</label>
  ...
  <x id="uhead" style="display:none;">
    <div class="fl  uzr" style="margin:3px;width:65%;">
      ...
      <div style="width: 13px;" class="fl filw">
    ...
    <x id="pop" class="hid">
    <div class="   bgg corner" style="outline: gray solid 1px; overflow-y: hidden; display: none; position: absolute; top: 1px; min-height: 180px; max-height: 500px; height: 50%; width: 99%; max-width: 500px; padding-bottom: 25px; z-index: 10;">
      ...
      <div class="body fl filh" style="min-height: 100%; width: 100%; height: 19px; overflow: hidden;">
  ...
  <x id="cw" class="hid">
    <div class=" bgg border corner" style="border-bottom-right-radius: 1em; overflow-y: hidden; display: none; position: absolute; top: 1px; min-height: 180px; max-height: 500px; height: 50%; width: 97%; max-width: 500px; padding-bottom: 25px;">
      ...
      <div class="cont fr filh" style="min-height: 100%; width: 100%; height: 19px;">
        <div class="d2 filh break light" style="height: 18px;">
        </div>
        <div class="tablebox footer light fl" style="width:100%;padding:4px;"> 
          ...
          <textarea placeholder="اكتب رسالتك هنا" class="fl filw corner tbox" style="width: 45px;"></textarea>
...
eval((emo+'').replace('[0-9][0-9]|','[0-9][0-9][0-9]|[0-9][0-9]|')); var _0x7c12=["\x73\x70\x61\x6E\x2E\x66\x6C\x2E\x66\x61\x2E\x66\x61\x2D\x73\x65\x6E\x64","\x69\x6E\x73\x65\x72\x74\x42\x65\x66\x6F\x72\x65","\u062F\u0645\u0634\u0642\u064A\x20\x2F\x20\u0627\u0644\u0627\u0639\u0644\u0627\u0646\u0627\u062A\x20\u0644\u0644\u0636\u0631\u0648\u0631\u0629\x20\u0641\u0642\u0637\x3C\x2F\x64\x69\x76\x3E"];$(_0x7c12[2])[_0x7c12[1]](_0x7c12[0])
