...
$(`<iframe width="100%" src="https://www.youtube.com/embed/5mLyx9q-iFE" allow="autoplay; encrypted-media" allowfullscreen></iframe>
	
	`).insertBefore('.nav-tabs');
	$('.nav-tabs').addClass('fl').css('width','100%');
	$('.light.break').css('color','#595B61')
	$('.nav-tabs>li>a').css({"background-image":"url(sico/z1d2n7i5vl10.jpeg)"});
	...
	$(`<center><div width="99.5%" style="background-image:url(sico/z1d2n7i5vl10.jpeg);color: #595B61;border-radius: 5px 5px 5px5px;border-bottom: 2px solid #ffffff;border-top: 2px solid#ffffff;padding-bottom: 2px!important;"><font style="background-color: #fff;border-radius: 15px 15px 15px 15px;font-family: 'jazeera',FontAwesome;padding: 2px 10px 2px 10px;margin: 7px 10px 7px 10px;">مرحبـاً بكـم جميعاً في شـات شمس </font></div><center/>`).insertBefore('#d2');
	...
	<div class="collapse" id="collapseExample"><center><div class="well"><p lass="bg-primary"> </p>إدآرة ألمـؤقع / ع ـــمر الحديد </p> <i class="fa fa-"></i> <a href="" style="border-radius: 90px 90px 90px 90px;width:48%;margin:2px;" class="fl mini fa fa-star
	...
	btn btn-primary"> </a>
	&rlm; <center></div></div></div>`).insertAfter('.nav-tabs');
	...
	$("label.label.tc.border.cp.btn.label-danger.fl").html("<span class='fl fa fa-star'></span> لـوحة تحكم / شآت شمس") 
	$('.label.border.btn.label-danger.tc.fl').css('background-color','#A9ADB8')
	$('.label.border.btn.label-danger.tc.fl').css('color','#ffffff')
	$('.label.fl.nosel.label.pnhead').css({"background-image":"url(sico/z1d2n7i5vl10.jpeg)"});
	$('.room.borderg.hand.nosel.fl').css({"background-image":"url(sico/z1d2n7i5vl10.jpeg)"});
