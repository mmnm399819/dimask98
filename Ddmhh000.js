...
<a id="des3" href=".com" style="border-radius: 24px 0px 24px 0px;width:26%;margin:2px;" class="fl mini  fa fa-image
btn btn-primary"> رمزيات </a>
<a id="des3" href=".com" style="border-radius: 0px 24px 0px 24px;width:24%;margin:2px;" class="fl mini  fa fa-paint-brush
